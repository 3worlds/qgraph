...
import au.edu.anu.qgraph.queries.base.*;
import au.edu.anu.qgraph.queries.base.primitive.*;
import au.edu.anu.qgraph.queries.base.string.*;
import au.edu.anu.qgraph.queries.graph.EdgeNodeSelection;
import au.edu.anu.qgraph.queries.graph.edge.*;
import au.edu.anu.qgraph.queries.graph.element.*;
import au.edu.anu.qgraph.queries.graph.node.*;
import au.edu.anu.qgraph.queries.graph.node.NodeCharacteristics.RootLeaf;
import au.edu.anu.qgraph.queries.graph.uml.IsEnumeration;
import au.edu.anu.qgraph.queries.graph.uml.IsMultiplicity;
import au.edu.anu.qgraph.queries.graph.uml.IsUMLAssociation;
 ...
 * {@link au.edu.anu.qgraph.queries.base.SequenceQuery#get(Object, Queryable...)

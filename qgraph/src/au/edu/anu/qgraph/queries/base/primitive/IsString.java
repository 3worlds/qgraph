 ...
 * 
 * @see au.edu.anu.qgraph.queries.CoreQueries#isString() CoreQueries.isString()
 * @see au.edu.anu.qgraph.queries.CoreQueries#stringOfLength(int, int) CoreQueries.stringOfLength(...)
 *
 */

 ...
 * with method {@link au.edu.anu.qgraph.queries.base.SelectQuery#query(Queryable) query(...)}). <br/>
 ...
 * 
 * @see au.edu.anu.qgraph.queries.CoreQueries#selectOne() CoreQueries.selectOne()
 * @see au.edu.anu.qgraph.queries.CoreQueries#selectOne(Queryable) CoreQueries.selectOne(Queryable)
 * @see au.edu.anu.qgraph.queries.CoreQueries#selectZeroOrOne() CoreQueries.selectZeroOrOne()
 * @see au.edu.anu.qgraph.queries.CoreQueries#selectZeroOrOne(Queryable) CoreQueries.selectZeroOrOne(Queryable)
 * @see au.edu.anu.qgraph.queries.CoreQueries#selectZeroOrMany() CoreQueries.selectZeroOrMany()
 * @see au.edu.anu.qgraph.queries.CoreQueries#selectZeroOrMany(Queryable) CoreQueries.selectZeroOrMany(Queryable)
 * @see au.edu.anu.qgraph.queries.CoreQueries#selectOneOrMany() CoreQueries.selectOneOrMany()
 * @see au.edu.anu.qgraph.queries.CoreQueries#selectOneOrMany(Queryable) CoreQueries.selectOneOrMany(Queryable)
 *
 */

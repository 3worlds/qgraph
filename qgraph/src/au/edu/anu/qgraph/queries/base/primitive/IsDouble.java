 ...
 * @see au.edu.anu.qgraph.queries.CoreQueries#isDouble() CoreQueries.isDouble()
 * @see au.edu.anu.qgraph.queries.CoreQueries#doubleInRange(double, double) CoreQueries.doubleInRange(...)
 *
 */

 ...
 * 
 * @see au.edu.anu.qgraph.queries.CoreQueries#isDate() CoreQueries.isDate()
 * @see au.edu.anu.qgraph.queries.CoreQueries#dateInRange(Date, Date) CoreQueries.dateInRange(...)
 *
 */

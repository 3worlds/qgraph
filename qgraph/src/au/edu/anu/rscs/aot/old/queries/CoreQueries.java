 ...
 *                                                                        *
 **************************************************************************/
package au.edu.anu.rscs.aot.old.queries;

import java.util.Date;

import au.edu.anu.rscs.aot.old.queries.base.AndQuery;
import au.edu.anu.rscs.aot.old.queries.base.CountQuery;
import au.edu.anu.rscs.aot.old.queries.base.ForAllQuery;
import au.edu.anu.rscs.aot.old.queries.base.IfThenQuery;
import au.edu.anu.rscs.aot.old.queries.base.IsInstanceOf;
import au.edu.anu.rscs.aot.old.queries.base.IsQuery;
import au.edu.anu.rscs.aot.old.queries.base.NotQuery;
import au.edu.anu.rscs.aot.old.queries.base.OrQuery;
import au.edu.anu.rscs.aot.old.queries.base.PopQuery;
import au.edu.anu.rscs.aot.old.queries.base.ResetQuery;
import au.edu.anu.rscs.aot.old.queries.base.SelectQuery;
import au.edu.anu.rscs.aot.old.queries.base.SizeQuery;
import au.edu.anu.rscs.aot.old.queries.base.Value;
import au.edu.anu.rscs.aot.old.queries.base.XorQuery;
import au.edu.anu.rscs.aot.old.queries.base.primitive.IsBoolean;
import au.edu.anu.rscs.aot.old.queries.base.primitive.IsClass;
import au.edu.anu.rscs.aot.old.queries.base.primitive.IsDate;
import au.edu.anu.rscs.aot.old.queries.base.primitive.IsDouble;
import au.edu.anu.rscs.aot.old.queries.base.primitive.IsFloat;
import au.edu.anu.rscs.aot.old.queries.base.primitive.IsInteger;
import au.edu.anu.rscs.aot.old.queries.base.primitive.IsLong;
import au.edu.anu.rscs.aot.old.queries.base.primitive.IsString;
import au.edu.anu.rscs.aot.old.queries.base.primitive.IsStringList;
import au.edu.anu.rscs.aot.old.queries.base.string.ClassQuery;
import au.edu.anu.rscs.aot.old.queries.base.string.ContainsSubstring;
import au.edu.anu.rscs.aot.old.queries.base.string.DateString;
import au.edu.anu.rscs.aot.old.queries.base.string.DoubleString;
import au.edu.anu.rscs.aot.old.queries.base.string.EndsWith;
import au.edu.anu.rscs.aot.old.queries.base.string.EnumerationString;
import au.edu.anu.rscs.aot.old.queries.base.string.FileQuery;
import au.edu.anu.rscs.aot.old.queries.base.string.FloatString;
import au.edu.anu.rscs.aot.old.queries.base.string.InetAddressString;
import au.edu.anu.rscs.aot.old.queries.base.string.IntegerString;
import au.edu.anu.rscs.aot.old.queries.base.string.LongString;
import au.edu.anu.rscs.aot.old.queries.base.string.PatternString;
import au.edu.anu.rscs.aot.old.queries.base.string.StartsWith;
import au.edu.anu.rscs.aot.old.queries.base.string.StringLength;
import au.edu.anu.rscs.aot.old.queries.base.string.UserNameQuery;
import au.edu.anu.rscs.aot.old.queries.graph.GraphLogQuery;
import au.edu.anu.rscs.aot.old.queries.graph.HasOnlyNodes;
...
import au.edu.anu.rscs.aot.old.queries.graph.edge.EdgeLog;
import au.edu.anu.rscs.aot.old.queries.graph.edge.EdgeNodes;
import au.edu.anu.rscs.aot.old.queries.graph.edge.IsEdge;
import au.edu.anu.rscs.aot.old.queries.graph.element.ElementLabel;
import au.edu.anu.rscs.aot.old.queries.graph.element.ElementName;
import au.edu.anu.rscs.aot.old.queries.graph.element.ElementProperty;
import au.edu.anu.rscs.aot.old.queries.graph.node.HasEdges;
import au.edu.anu.rscs.aot.old.queries.graph.node.HasParent;
import au.edu.anu.rscs.aot.old.queries.graph.node.IsNode;
import au.edu.anu.rscs.aot.old.queries.graph.node.NodeCharacteristics;
import au.edu.anu.rscs.aot.old.queries.graph.node.NodeEdges;
import au.edu.anu.rscs.aot.old.queries.graph.node.NodeListEdges;
import au.edu.anu.rscs.aot.old.queries.graph.node.Trees;

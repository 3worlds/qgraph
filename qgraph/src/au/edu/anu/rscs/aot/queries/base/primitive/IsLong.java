 ...
 *
 * @see au.edu.anu.rscs.aot.queries.CoreQueries#isLong() CoreQueries.isLong()
 * @see au.edu.anu.rscs.aot.queries.CoreQueries#longInRange(long, long) CoreQueries.longInRange(...)
 */

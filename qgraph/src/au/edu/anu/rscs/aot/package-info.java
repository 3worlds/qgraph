 ...
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.base.AndQuery AndQuery}</td> 
 * 	   <td>check if all its sub-queries are satisfied</td>
 *     <td>{@link java.lang.Object Object}</td> <tr/>
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.base.OrQuery OrQuery}</td> 
 * 	   <td>check if at least one of its sub-queries are satisfied</td>
 *     <td>{@link java.lang.Object Object}</td> <tr/>
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.base.NotQuery NotQuery}</td> 
 * 	   <td>check if none of its sub-queries are satisfied</td>
 *     <td>{@link java.lang.Object Object}</td> <tr/>
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.base.XorQuery XorQuery}</td> 
 * 	   <td>check if exactly one of its sub-queries are satisfied</td>
 *     <td>{@link java.lang.Object Object}</td> <tr/>
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.base.CountQuery CountQuery}</td> 
 * 	   <td>check  that an integer ('count') is within a range</td>
 *     <td>{@link java.lang.Integer Integer}</td> <tr/>
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.base.SizeQuery SizeQuery}</td> 
 ...
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.base.SelectQuery SelectQuery}</td> 
 ...
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.base.SequenceQuery SequenceQuery}</td> 
 * 	   <td>select objects that satisfy a series of queries chained after the other, starting on a single object</td>
 *     <td>{@link  java.lang.Object Object}</td> <tr/>
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.base.IsQuery IsQuery}</td> 
 ...
 *     <td>{@link java.lang.String String}</td> <tr/>
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.graph.element.ElementLabel ElementLabel}</td> 
 ...
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.graph.element.ElementName ElementName}</td> 
 ...
 *     
 * <tr><td>{@link au.edu.anu.rscs.aot.queries.graph.element.ElementProperty ElementProperty}</td> 
 ...
 * </table>
 * 
 * <p>Static methods in the {@link au.edu.anu.rscs.aot.queries.CoreQueries CoreQueries} class implement

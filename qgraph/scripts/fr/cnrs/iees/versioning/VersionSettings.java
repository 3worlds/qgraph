...
public class VersionSettings {
	...
	protected static String ORG = "au.edu.anu.qgraph";

	/** The name of the ivy module (this will be the name of the generated jar file for
	 * dependent projects).*/
	protected static String MODULE = "qgraph";
	...
	protected static String DESCRIPTION =
		"This module is a graph querying system. It implements classes to search a graph in various"
		+ "ways by looking at node and edge properties, location in the graph, and many other things.";
